...
describe Project do
  ...
  it 'knows that a project withan incomplete task is not done' do
    project.tasks << task
...
describe 'estimates' do
  let(:project) { Project.new }
  let(:done) { Task.new(size: 2, completed_at: 6.months.ago) }
  ...
  it 'properly handles a blank project' do
    ...
    expect(project.projected_days_remaining).to be_infinite
